...
<div class="container">
   @can('isAdmin')        
    ...
    <div class="row">
        <div class="col-lg-7 mb-6"><h4 style="font-weight: bold">Bouquet</h4></div>
        ...
        <br><br>
        <div class="row">
            @forelse ($bouquets as $product)
            <div class="col-xl-3">
                <div class="bouquet ml-auto">
                    <a><img class="bouquet_img" src="{{ asset('storage/bouquet/'.$product->image )}}"></a>
                    <br><br>
                    <a>{{ $product->title }}</a>
                    <br>
                    ${{ $product->price }}
                    <br><br>
                    <p style="color: grey; font-size: 12px;">{{ $product->size }}</p>
                </div> {{-- bouquet end --}}
            </div>
